...
public class CafeAndRestauranRecyclerviewAdapter extends RecyclerView.Adapter<CafeAndRestauranRecyclerviewAdapter.MyViewHolder> {
    ...
    public CafeAndRestauranRecyclerviewAdapter(Context mContext, List<HotelsAdapterModel> albumList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        //Glide.with(mContext).load(ProjectStatic.IMAPGE_PATH+model.getPhoto_path()).into(holder.mall_phtoto);
            ...
            public void onClick(View view) {
                ...
                Call<ResponseMessage> call=client.add_caferes_as_customers(token,view.getTag().toString());
