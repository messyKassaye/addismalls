...
public class VacancyModel {
    ...
    public VacancyModel(String id, String job_title, String name, String salary, String employment_type, String qualifications, String years_exp, String description, String deadline) {
        this.id = id;
