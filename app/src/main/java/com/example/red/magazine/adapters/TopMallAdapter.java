...
public class TopMallAdapter extends RecyclerView.Adapter<TopMallAdapter.MyViewHolder> {

    private Context mContext;
    private List<TopMallsAdapterModel> albumList;
    ...
    public TopMallAdapter(Context mContext, List<TopMallsAdapterModel> albumList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        TopMallsAdapterModel model = albumList.get(position);
